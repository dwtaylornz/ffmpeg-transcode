...
$restart_queue = 1440 # mins before re-doing the scan and start going through the queue again

# transcode and processing 
$ffmpeg_video_codec = "av1_amf" # set to av1_amf for HW AMD, libsvtav1 for CPU
...
$ffmpeg_aac = 1 # 0 copies audio (no changes), set to 1 if you want to transcode audio to AAC (2 channel)
...
$video_codec_skip_list = "av1", "hevc" # skip transcoding if video codec is in this list
